        ...
        if(DB::table('travel_news')->get()->count()==0){
            DB::table('travel_news')->insert([
                [
                    ...
                    'intro' => "'Chỉ phó nháy chất lượng thôi là chưa đủ. Để có một bức ảnh xinh để trang hoàng Facebook hay Instagram cần nhiều yếu tố. Trong đó yếu tố quan trọng nhất nhì chính là bước chỉnh màu ảnh. Cùng Halotravel nằm lòng công thức chỉnh ảnh đẹp 2020 đang trend trên mạng bằng Foodie nhé!'",
                    'category_id' => 1,
